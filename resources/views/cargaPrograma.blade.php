<x-esqueleto>
    ...
    <div class="lg:w-full p-4 bg-white shadow-md rounded-lg text-center transition-all duration-2000">
        <div class="w-10/12 py-4 px-2 mx-auto max-w-screen-xl lg:py-3 lg:px-2 
            ...
            <form class="bg-white shadow-md rounded px-8 pt-2 pb-2 mb-2" id="" method="" action="">
                <div class="grid gap-6 mb-6">
                    ...
                    <!-- Sección Temas y Subtemas -->
                        <div id="temas-container">
                            <!-- Aquí se añadirán dinámicamente los temas -->
                        </div>
                        <div class="flex flex-row justify-around">
                            <button type="button" onclick="agregarTema()"
                                class="text-white font-bold rounded-lg text-sm w-full sm:w-1/2 px-5 py-2.5 text-center 
    ...
    <!--script para el manejo de captura del becario-->
