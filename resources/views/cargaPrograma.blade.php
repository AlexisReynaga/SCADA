<x-esqueleto>
    ...
    <div class="lg:w-full p-4 bg-white shadow-md rounded-lg text-center transition-all duration-2000">
        <div class="w-10/12 py-4 px-2 mx-auto max-w-screen-xl lg:py-3 lg:px-2 border-4 border-gray-300 rounded-lg bg-gray-200 mt-0 pt-0">
            <!-- Formulario para enviar los datos del programa de estudio -->
            <form class="bg-white shadow-md rounded px-8 pt-2 pb-2 mb-2" method="POST" action="{{ route('home.programa.guardarMateria') }}">
                ...
                <div class="grid gap-6 mb-6">
                    ...
                    <!-- Campo: ID Clave de la Materia -->
                    <div>
                        <label for="id_clave" class="block mb-2 font-bold text-blue-700 text-left text-base">
                            ID Clave de la Materia
                        </label>
                        <input 
                            type="number" 
                            id="id_clave" 
                    ...
                    <!-- Campo: Créditos -->
                    <div>
                        <label for="creditos" class="block mb-2 font-bold text-blue-700 text-left text-base">
                            Créditos
                        </label>
                        <input 
                            type="number" 
                    ...
                    <!-- Botones de elección de la carrera -->
                    <div class="mt-4">
                    ...
                    <div>
                        ...
                        <button type="button" id="add-tema" class="text-white font-bold rounded-lg w-full sm:w-auto px-5 py-2.5 text-center text-sm bg-blue-700 hover:bg-blue-500 transition-all duration-1000 ease-in-out">
                            Agregar Tema
                        </button>
                    </div>
                </div>
